...
firebase.auth().onAuthStateChanged(function(user) {
  if (user) {
    ...
    if(isRegistration){
      ...
      var key = firebase.database().ref().child('StudentRegistrationData').push().key;
...
loginBtn.addEventListener('click', function(){
  ...
  var email = document.getElementById('stu_login_email').value;
  var pwd = document.getElementById('stu_login_pwd').value;
...
registerBtn.addEventListener('click', function(){
  ...
  var school = document.getElementById('stu_school').value;
  var enroll = document.getElementById('stu_enrll_num').value;
  var pwd = document.getElementById('stu_pwd').value;
  var confPwd = document.getElementById('stu_conf_pwd').value;
        ...
        // }else{
          if(pwd.length < 8){
            ...
            if(pwd!==confPwd){
              ...
              registrationDataObj.enrollmentNumber = enroll;
